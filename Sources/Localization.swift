...
internal enum L10n {
    static let strings: [String: [String: String]] = [
        ...
        "note": ["en": "Open the address below in a browser on the same Wi-Fi. Entering the background keeps the service and connections open; iOS may suspend the app. Your switch preference is saved for the next launch.", "zh": "在同一 Wi-Fi 的浏览器中打开下方地址。App 退后台时保留服务和连接；iOS 仍可能挂起 App。开关选择会在下次启动时恢复。"],
        ...
        "paused": ["en": "Service paused", "zh": "服务已暂停"],
